...
[[ -L "$PROJECT/.agents/skills/finish" ]] || fail "resync did not install the Codex finish skill"
[[ "$(readlink "$PROJECT/.agents/skills/finish")" == '../../.riff/skills/finish' ]] || fail "resynced Codex finish skill link target wrong"
[[ -L "$PROJECT/.claude/skills/finish" ]] || fail "resync did not install the Claude finish skill"
[[ "$(readlink "$PROJECT/.claude/skills/finish")" == '../../.riff/skills/finish' ]] || fail "resynced Claude finish skill link target wrong"
