...
[[ -L "$WORK_DIR/.claude/skills/finish" ]] || fail "finish Claude skill link missing"
[[ "$(readlink "$WORK_DIR/.claude/skills/finish")" == "../../.riff/skills/finish" ]] || fail "finish Claude skill link target wrong"
[[ -L "$WORK_DIR/.agents/skills/finish" ]] || fail "finish Codex skill link missing"
[[ "$(readlink "$WORK_DIR/.agents/skills/finish")" == "../../.riff/skills/finish" ]] || fail "finish Codex skill link target wrong"
